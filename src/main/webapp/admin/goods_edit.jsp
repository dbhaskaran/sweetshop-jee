...
<div class="container-fluid">
	...
	<form class="form-horizontal" action="/admin/goods_edit" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			<label for="input_name" class="col-sm-1 control-label">Intro</label>
			<div class="col-sm-6">
		...
		<div class="form-group">
			<label for="input_file" class="col-sm-1 control-label">Detail Picture 1</label>
		...
		<div class="form-group">
			<label for="input_file" class="col-sm-1 control-label">Detail Picture 2</label>
