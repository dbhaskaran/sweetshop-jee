...
<div class="banner">
    <div class="container">
        ...
        <p>Todays Specials</p>
        <a class="banner_a" href="javascript:;" onclick="buy(${scroll.id})">Buy</a>
...
<div class="gallery">
    <div class="container">
        <div class="alert alert-danger">Hot Recommendation</div>
                ...
                <div class="col-md-4 gallery-grid glry-two">
                    ...
                    <div class="gallery-info galrr-info-two">
                        <p>
                            ...
                            <a href="/goods_detail?id=${g.id}">see details</a>
                        </p>
        ...
        <div class="clearfix"></div>
        <div class="alert alert-info">New Products</div>
        <div class="gallery-grids">
