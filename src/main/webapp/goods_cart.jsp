	...
	<div class="cart-items">
		<div class="container">
				...
				<div class="cart-header col-md-6">
					<div class="cart-sec simpleCart_shelfItem">
						...
						<div class="cart-item-info">
							...
							<a class="btn btn-warning" href="javascript:lessen(${item.key});">Decrease</a>
			...
			<div class="cart-header col-md-12">
				...
				<a class="btn btn-success btn-lg" style="margin-left:74%" href="/order_submit">Submit Order</a>
			</div>
